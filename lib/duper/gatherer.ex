defmodule Duper.Gatherer do
  ...
  def init(worker_count) do
    # start workers after this has finished initializing, so that we don't miss
    # any children's messages sent.
  ...
  def handle_info(:kickoff, worker_count) do
    1..worker_count
    |> Enum.each(fn _i -> Duper.WorkerSupervisor.add_worker() end)
